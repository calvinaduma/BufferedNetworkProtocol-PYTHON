...
if __name__ == "__main__":
    l = TestMessaging()
    l.test_short_message()
    print("PASSED: Short Message")
    l.test_medium_message()
    print("PASSED: Medium Message")
    l.test_long_message()
    print("PASSED: Long Message")
    l.test_multiple_messages_in_series()
    print("PASSED: Series Message")
    l.test_multiple_messages_in_parallel()
    print("PASSED: Multiple Message")